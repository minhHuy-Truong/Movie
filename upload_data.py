...
    init_playwright()  # Initialize browser once
    
    trending = get_tmdb_top_trending(n, period=TMDB_TRENDING_PERIOD)
    
    # Check if trending is valid
...
            tiktok_info = get_tiktok_with_playwright(metadata["title"])  # Using Playwright
            
...
============================================================
Starting Movie Trending Crawler
============================================================
...
    
    close_playwright()  # Close browser after all processing
    return output
